...
const envSchema = z.object({
  ...
  // Mem0 Configuration - Required for memory functionality
...
const validateProductionEnvironment = (env: any) => {
  ...
  // Validate API keys are not defaults
  if (env.MEM0_API_KEY === 'your_mem0_api_key') {
    errors.push('MEM0_API_KEY must be set to real value in production');
  }
